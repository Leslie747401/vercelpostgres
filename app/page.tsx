...
export default function Home() {
  ...
  return (
   <form className="w-screen h-screen flex flex-col gap-10 justify-center items-center">
      ...
      <input type="submit" className="bg-black px-4 py-2 text-white rounded-lg cursor-pointer" value={userInput} onChange={(e) => setUserInput(e.target.value)}>Submit</input>
   </form>
  );
}
